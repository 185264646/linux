...
#define HI3798MV200_COMBPHY0_MUX		77
...
static const char *const gsf_mux_p[] = {
		"125m", "75m" };
static u32 gsf_mux_table[] = {0, 1};
...
static struct hisi_mux_clock hi3798mv200_mux_clks[] = {
	...
	{ HISTB_SDIO1_MUX_CLK, "sdio1_mux", sdio_mux_p, ARRAY_SIZE(sdio_mux_p),
		CLK_SET_RATE_PARENT, 0x28c, 8, 2, 0, sdio_mux_table, },
...
static const struct hisi_gate_clock hi3798mv200_gate_clks[] = {
	...
	/*
	 * Due to the absence of an FOSS USB phy driver, we have to do the
	 * initialization in boot loader. And don't touch the gate clock
	 * anymore.
	 *
	 *  Add CLK_IS_CRITICAL to avoid disabling it.
	 */
