 ...
 * Adapted form crg-hi3798cv200.c
 *
...
#define HI3798MV200_FIXED_12P5M			66
#define HI3798MV200_FIXED_25M			67
#define HI3798MV200_FIXED_27M			68
#define HI3798MV200_FIXED_50M			69
#define HI3798MV200_FIXED_54M			70
#define HI3798MV200_FIXED_75M			71
#define HI3798MV200_FIXED_100M			72
#define HI3798MV200_FIXED_125M			73
#define HI3798MV200_FIXED_150M			74
#define HI3798MV200_FIXED_168P75M		75
#define HI3798MV200_FIXED_200M			76
#define HI3798MV200_MMC_MODE0_MUX		77
#define HI3798MV200_MMC_MODE1_MUX		77
#define HI3798MV200_SDIO0_MODE0_MUX		78
#define HI3798MV200_SDIO0_MODE1_MUX		78
#define HI3798MV200_SDIO1_MODE0_MUX		79
#define HI3798MV200_SDIO1_MODE1_MUX		79
#define HI3798MV200_COMBPHY0_MUX		80
...
static const struct hisi_fixed_rate_clock hi3798mv200_fixed_rate_clks[] = {
	...
	{ HI3798MV200_FIXED_168P75M, "168p75m", NULL, 0, 168750000, },
	{ HI3798MV200_FIXED_200M, "200m", NULL, 0, 200000000, },
};

static const char *const mmc_mux_mode0_p[] = {
		"100m", "50m", "25m", "200m", "150m" };
static u32 mmc_mux_mode0_table[] = {0, 1, 2, 3, 6};

static const char *const mmc_mux_mode1_p[] = {
		"50m", "25m", "12p5m", "100m", "150m", "168p75m", "75m" };
static u32 mmc_mux_mode1_table[] = {0, 1, 2, 3, 4, 5, 6};

static const char *const mmc_mux_p[] = {
		"mmc_mux_mode0", "mmc_mux_mode1" };
static u32 mmc_mux_table[] = {0, 1};

static const char *const comphy_mux_p[] = {
		"100m", "25m"};
static u32 comphy_mux_table[] = {0, 1};

static const char *const sdio_mux_mode0_p[] = {
		"100m", "50m", "150m", "25m" };
static u32 sdio_mux_mode0_table[] = {0, 1, 2, 3};

static const char *const sdio_mux_mode1_p[] = {
		"50m", "25m", "75m", "12p5m" };
static u32 sdio_mux_mode1_table[] = {0, 1, 2, 3};

static const char *const sdio_mux_p[] = {
		"sdio_mux_mode0", "sdio_mux_mode1" };
static u32 sdio_mux_table[] = {0, 1};

static struct hisi_mux_clock hi3798mv200_mux_clks[] = {
	{ HI3798MV200_MMC_MODE0_MUX, "mmc_mux_mode0", mmc_mux_mode0_p, ARRAY_SIZE(mmc_mux_mode0_p),
		CLK_SET_RATE_PARENT, 0xa0, 8, 3, 0, mmc_mux_mode0_table, },
	{ HI3798MV200_MMC_MODE1_MUX, "mmc_mux_mode1", mmc_mux_mode1_p, ARRAY_SIZE(mmc_mux_mode1_p),
		CLK_SET_RATE_PARENT, 0xa0, 8, 3, 0, mmc_mux_mode1_table, },
	{ HISTB_MMC_MUX_CLK, "mmc_mux", mmc_mux_p, ARRAY_SIZE(mmc_mux_p),
		CLK_SET_RATE_PARENT, 0xa0, 19, 1, 0, mmc_mux_table, },
	{ HI3798MV200_SDIO0_MODE0_MUX, "sdio0_mux_mode0", sdio_mux_mode0_p, ARRAY_SIZE(sdio_mux_mode0_p),
		CLK_SET_RATE_PARENT, 0xa0, 8, 2, 0, sdio_mux_mode0_table, },
	{ HI3798MV200_SDIO0_MODE1_MUX, "sdio0_mux_mode1", sdio_mux_mode1_p, ARRAY_SIZE(sdio_mux_mode1_p),
		CLK_SET_RATE_PARENT, 0xa0, 8, 2, 0, sdio_mux_mode1_table, },
	{ HISTB_SDIO0_MUX_CLK, "sdio0_mux", sdio_mux_p, ARRAY_SIZE(sdio_mux_p),
		CLK_SET_RATE_PARENT, 0xa0, 19, 1, 0, sdio_mux_table, },
	{ HI3798MV200_SDIO1_MODE0_MUX, "sdio1_mux_mode0", sdio_mux_mode0_p, ARRAY_SIZE(sdio_mux_mode0_p),
		CLK_SET_RATE_PARENT, 0x28c, 8, 3, 0, sdio_mux_mode0_table, },
	{ HI3798MV200_SDIO1_MODE1_MUX, "sdio1_mux_mode1", sdio_mux_mode1_p, ARRAY_SIZE(sdio_mux_mode1_p),
		CLK_SET_RATE_PARENT, 0x28c, 8, 3, 0, sdio_mux_mode1_table, },
	{ HISTB_SDIO1_MUX_CLK, "sdio1_mux", sdio_mux_p, ARRAY_SIZE(sdio_mux_p),
		CLK_SET_RATE_PARENT, 0x28c, 19, 1, 0, sdio_mux_table, },
...
static const struct hisi_gate_clock hi3798mv200_gate_clks[] = {
	...
	{ HI3798MV200_FEMACIF_CLK, "clk_macif1", NULL,
	...
	{ HISTB_USB2_PHY2_REF_CLK, "clk_u2_phy2_ref", NULL,
		CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0xbc, 2, 0 },
	/* USB3 */
...
#define HI3798MV200_UART0_MUX_CLK	1
